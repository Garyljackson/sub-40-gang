  ...
  return (
    <main className="space-y-6 p-4">
      <header className="flex items-center gap-4">
        ...
        />
        <div>
          <h1 className="text-2xl font-bold text-gray-100">{profileData.member.name}</h1>
          <p className="text-gray-400">
            {profileData.totalAchieved} / 5 milestones in {profileData.season}
          </p>
        </div>
      </header>

      <section>
        <h2 className="mb-3 text-lg font-semibold text-gray-100">Milestones</h2>
        <MilestoneGrid milestones={profileData.milestones} />
      </section>

      <section>
        <h2 className="mb-3 text-lg font-semibold text-gray-100">Last Synced Run</h2>
        {recentActivity ? (
